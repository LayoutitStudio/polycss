...
|------|------|---------|-------------|
| `zoom` | `number` | `0.65` | On-screen CSS pixels per world unit — at `zoom: 50` one world unit renders 50 px across. Higher zooms in, lower zooms out; orbit controls clamp to `0.1`–`10` by default (`minZoom` / `maxZoom`). |
