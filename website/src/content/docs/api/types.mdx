...
interface Polygon {
   ...
   *  colors. Unparseable values render white. Falls back to "#cccccc" when
   *  neither color nor texture is set. */
  color?: string;
