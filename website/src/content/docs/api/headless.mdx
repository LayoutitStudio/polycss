...
| `@layoutit/polycss-morph` | Browser-safe prepared-model contracts, loading, retained mounting, sparse deformation, controls, springs, animation, skinning, and playback; Node preparation is exported separately from `/prepare` |
