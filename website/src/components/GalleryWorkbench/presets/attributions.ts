...
export const POLYCSS_GENERATED_PRIMITIVE_ATTRIBUTION: ModelAttribution = {
  creator: "Generated by polycss",
};

export const POLYCSS_LOCAL_FIXTURE_ATTRIBUTION: ModelAttribution = {
  creator: "Local polycss fixture",
};
...
const POLY_PIZZA_CITY_PACK_URL = "https://poly.pizza/bundle/City-Pack-kJqRAIGsw0";

function polyPizzaCityPackAttribution(creator: string, license: string): ModelAttribution {
  return {
    creator,
    license,
...
export function polyPizzaJeremyAttribution(publicId: string): ModelAttribution {
  return polyPizzaAttribution("jeremy", publicId, "CC-BY 3.0");
}
