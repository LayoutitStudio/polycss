/**
 * Feature tests: packTextureAtlasPlansWithScale wrapper (Vue atlasBrowser copy)
 *
 * Mirrors React's atlasBrowser.packing.test.ts.
...
import { packTextureAtlasPlansWithScale, isMobileDocument } from "../atlasBrowser";
