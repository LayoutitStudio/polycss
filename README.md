...
A CSS polygon mesh library. A 3D engine for the DOM. Renders OBJ, glTF, GLB and VOX as real HTML elements transformed with CSS `matrix3d(...)`. Supports colors, textures, lighting, shadows, shapes and animations. Works with React, Vue, custom elements, or plain JavaScript.
